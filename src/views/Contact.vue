<template>
    ...
    <div class="container mx-auto px-4 max-w-7xl">
      <div class="flex flex-wrap">
        ...
        <div class="w-full px-4 lg:w-1/2">
          <h2
            class="mb-4 max-w-md text-3xl font-bold text-dark dark:text-white lg:pt-10 lg:text-4xl"
          >
            Butuh Informasi ?
          </h2>
          <p class="mb-6 text-base font-medium text-secondary lg:text-lg">
            ...
            Jangan ragu untuk menghubungi kami untuk informasi lebih lanjut atau
            dukungan.
          </p>
  ...
  <!-- CONTACT -->
  <section id="contact-page" class="py-10 dark:bg-dark">
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            <form>
              ...
              <div class="flex justify-center">
                <button
                  type="submit"
                  class="text-base font-semibold text-white bg-primary py-3 px-20 hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out"
                >
                  Kirim
                </button>
              </div>
